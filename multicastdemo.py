...
class LinuxRouter( Node ):
    ...
    def config( self, **params ):
        ...
        self.cmd( 'sleep 1')
        self.cmd( 'sudo smcroutectl -I smcroute-r0 '
...
class EdgeNode( Node ):
    ...
    def config( self, **params ):
        ...
        self.cmd( 'sleep 1')
        self.cmd( 'sudo smcroutectl -I smcroute-' + self.name +
...
def run():
    ...
    r0.cmd( 'smcrouted -l debug -I smcroute-r0' )
    r0.cmd( 'sudo smcroutectl -I smcroute-r0 add r0-eth1 239.0.0.1 r0-eth2 r0-eth3' )
    """
